...
def arg_type(x: int) -> str:
    return (
        check_argument_types()
    )  # noqa: E501 # error: Incompatible return value type (got "bool", expected "str")
...
_ = arg_type(
    foo
)  # noqa: E501 # error: Argument 1 to "arg_type" has incompatible type "Callable[[int], int]"; expected "int"
_ = foo(
    "typeguard"
...
_ = get_value(
    "foo"
)  # noqa: E501 # error: Argument 1 to "get_value" has incompatible type "str"; expected "MyClass"
_ = MyClass(
    returns_str()
)  # noqa: E501 # error: Argument 1 to "MyClass" has incompatible type "str"; expected "int"
